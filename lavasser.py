...
# ==========================================
# 🔑 CONFIGURATION GOOGLE (CORRECTION 404)
# ==========================================
API_KEY = st.secrets["API_KEY"] 
client = genai.Client(api_key=API_KEY)

# Utilisation du modèle 2.0 Flash : plus robuste aux erreurs de version d'API
...
def generate_detailed_analysis(tasks, flows):
    ...
    3. 🔵 Architecture SAP B1 10.0 (Objet Technique REEL, Chemin Menu, Données Maîtres et Impact Stock/Compta).
    """
    try:
        # Tentative avec le modèle 2.0
        ...
        # Secours ultime avec le nom complet 1.5
        try:
    ...
    if st.button("🚀 Générer l'Analyse SAP", type="primary"):
        with st.spinner("Analyse en cours..."):
            ...
            if tasks_txt:
                ...
                st.error("Fichier BPMN illisible.")
